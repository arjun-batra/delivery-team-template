...
## The audit (run all four passes every time)
...
## Rules
- Every log entry: ID (REV-NNN), tag, severity (blocker/major/minor), location, description, suggested owner (pm / tech-lead / dev / qa).
